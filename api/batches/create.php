...
if( //$data->batch_id != NULL
   ...
   // $batch->batch_id = $data->batch_id;
    ...
    $batch->last_modified =  date('Y-m-d H:i:s'); //$data->last_modified;
    ...
    if($batch->create()){
        ...
        echo json_encode(array("message" => "Batch created successfully"));
     }else{
        ...
        echo json_encode(array("message" => "Batch create unsuccessful"));
...
$url_adjustments = "http://localhost/api/adjustment/create.php";
